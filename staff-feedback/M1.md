...
Great diagram! Very complete and comprehensible!
...
Make sure to setup Sonar Cloud in the repo to see the coverage in the PRs and the CI. 
On Sonar, it says that you had 90+ % coverage this morning (Friday), but that now you only have 60.9%. This is sad! Pay attention to merges that drastically reduce coverage.
We advise you to be more generous with testing, as it will strengthen your ability to spot bugs that you will have.
You do not have any end-to-end. Remember to test the app from a user perspective, starting from the login, then navigating through the app and performing actions. Then check that the results are expected / the changes are reflected in the UI.

For this part, you received 14 points out of a maximum of 33.
...
Unfortunately, due to an authentication problem, we cannot test the app.
...
- (Minor Bug) We cannot create an account on the Sign Up screen.
...
You really planned ahead the user stories! Great work!
Good ! You really make the effort of trying to estimate tasks!
Great Scrum Board!
